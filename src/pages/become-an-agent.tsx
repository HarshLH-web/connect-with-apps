  ...
  return (
    <>
      ...
      <section className="pt-10 pb-10 lg:pt-20 lg:pb-20 bg-[#f8ecee]">
        <div className="w-[90%] max-w-5xl mx-auto flex flex-col lg:flex-row gap-4 items-center justify-center -mt-32">
          <div className="bg-linear-to-t from-[#F8ECEE] to-[#FEFEFC] border border-[#DFDFDF] rounded-3xl w-[90%] max-w-88 mx-auto py-4 lg:py-6">
            <div className="max-w-2xl mx-auto py-4">
              <form onSubmit={handleSubmit} className="w-full">
                <div className="flex flex-col gap-2 lg:gap-4">
                  <div className="flex flex-col gap-2 lg:gap-3 w-[90%] mx-auto">
                      ...
                      <div className="relative" ref={dropdownRef}>
                        <div
                          ...
                          onKeyDown={(e) => {
                            if (/^[a-zA-Z]$/.test(e.key) && open) {
                              const idx = countryCodes.findIndex(
                                (c: CountryCode) =>
                                  c.label
                                    .toLowerCase()
                        ...
                        {open && (
                          <div className="absolute left-0 mt-1 w-72 bg-white border border-gray-300 rounded-md shadow-lg z-50 max-h-80 overflow-y-auto">
                            {countryCodes.map(
                              (country: CountryCode, index: number) => (
                                <div
          ...
          <div>
            <ul className="list-disc list-inside">
              <li><span className="font-semibold text-lg lg:text-xl">Build Your Own Agency.</span></li>
              <li><span className="font-semibold text-lg lg:text-xl">Lead a Global Team.</span></li>
              <li><span className="font-semibold text-lg lg:text-xl">Turn Your Leadership into Weekly Profits.</span></li>
            </ul>
            <p className="text-left text-base lg:text-xl text-[#393939] lg:leading-snug mt-4">Fill out this form to start your journey as an agent!</p>
            <p className="text-left text-xl lg:text-3xl font-bold mt-2 lg:mt-4  bg-linear-to-t from-[#353D76] to-[#8086B3] text-transparent  bg-clip-text">Register Today!</p>
          </div>
        </div>
      </section>

      <section className="py-10 lg:pt-20 lg:pb-20 bg-[url('/vission-bg.png')] bg-cover bg-center">
        <h2 className="text-center text-2xl lg:text-5xl font-semibold text-[#ffffff] my-2 max-w-5xl mx-auto">
          Who are Agents?
        </h2>

        <p className="text-center text-base lg:text-xl text-[#ffffff] my-2 max-w-5xl mx-auto px-2 mt-2 lg:mt-4">
          Agents are the “behind-the-scenes” supporters of streamers. As an
          agent, you recruit talented streamers & sub-agents and support them in
          their journey. You are the link between talented creators and live
          streaming platforms.
        </p>
      </section>
      ...
      <section className="py-10 lg:pt-20 lg:pb-12 bg-[#ffffff]">
        <div className="w-[90%] max-w-3xl mx-auto ">
          <h2 className="text-2xl lg:text-5xl font-bold text-center max-w-4xl mx-auto lg:leading-none lg:px-6">
            What are the responsibilities of an agent?
          </h2>
          <p className="text-base lg:text-xl text-[#393939] lg:leading-snug mt-4 text-center">
            Your job is to build and manage a team of successful streamers &
            sub-agents. As an agent, your tasks include:
          </p>
          <div className="mt-4 lg:mt-8">
            <p className="flex items-center gap-2">
              <Image
                ...
                height={20}
              />{" "}
              <span className="text-base lg:text-[18px] text-[#393939] lg:leading-snug">
                Recruiting people who want to earn money on live streaming apps.
              </span>
            </p>
            ...
            <p className="flex items-center gap-2">
              ...
              />{" "}
              <span className="text-base lg:text-[18px] text-[#393939] lg:leading-snug">
                Helping your team to set up their account and pass verification.
              </span>
            </p>
            <hr className="w-full border-t border-[#DFDFDF] my-3" />
            <p className="flex items-center gap-2">
              ...
              />{" "}
              <span className="text-base lg:text-[18px] text-[#393939] lg:leading-snug">
                Sharing tips on how to get more gifts and followers.
              </span>
            </p>
            <hr className="w-full border-t border-[#DFDFDF] my-3" />
            <p className="flex items-center gap-2">
              ...
              />{" "}
              <span className="text-base lg:text-[18px] text-[#393939] lg:leading-snug">
                Track your team&apos;s performance through your agency
                dashboard.
              </span>
            </p>
            <hr className="w-full border-t border-[#DFDFDF] my-3" />
            <p className="flex items-center gap-2">
              ...
              />{" "}
              <span className="text-base lg:text-[18px] text-[#393939] lg:leading-snug">
                Grow your income by adding more streamers & sub-agents in the
                agency.
              </span>
            </p>
          </div>
